          ...
          <tbody>
              @foreach($item as $row)
                ...
                <tr>
                  ...
                  <td>{{ $row['nis'] }}</td>
                  <td>{{ $row['nama'] }}</td>
                  <td>Rp. {{ number_format($row['juli'],2) }}</td>
                  <td>Rp. {{ number_format($row['agustus'],2) }}</td>
                  <td>Rp. {{ number_format($row['september'],2) }}</td>
                  <td>Rp. {{ number_format($row['oktober'], 2) }}</td>
                  <td>Rp. {{ number_format($row['november'], 2) }}</td>
                  <td>Rp. {{ number_format($row['desember'], 2) }}</td>
