  ...
  <a href="{{ url('laporan/pembayaran') }}">
    <div class="col-lg-3 col-sm-offset-1">
      ...
      <div class="small-box bg-yellow">
        <div class="inner">
          <h3 align="center"><i class="fa fa-file-text fa-lg" aria-hidden="true"></i></h3>

          <p align="center">Laporan Pembayaran</p>
        </div>
        {{-- <div class="icon">
      ...
      <div class="col-lg-3 col-sm-offset-1">
        ...
        <div class="small-box bg-yellow">
          <div class="inner">
            ...
            <p align="center">Laporan Rekapitulasi</p>
          </div>
          {{-- <div class="icon">
            <i class="ion ion-bag"></i>
          </div> --}}
      ...
      <div class="col-lg-3 col-sm-offset-1">
        ...
        <div class="small-box bg-yellow">
          <div class="inner">
            ...
            <p align="center">Laporan Tunggakan</p>
          </div>
          {{-- <div class="icon">
            <i class="ion ion-bag"></i>
          </div> --}}
      ...
      <div class="col-lg-3 col-sm-offset-1">
        ...
        <div class="small-box bg-yellow">
          <div class="inner">
            ...
            <p align="center">Laporan Pertanggung Jawaban</p>
          </div>
          {{-- <div class="icon">
            <i class="ion ion-bag"></i>
          </div> --}}
      ...
      <div class="col-lg-3 col-sm-offset-1">
        ...
        <div class="small-box bg-yellow">
          <div class="inner">
            ...
            <p align="center">Laporan Arus Kas</p>
          </div>
          {{-- <div class="icon">
            <i class="ion ion-bag"></i>
          </div> --}}
    ...
    <a href="{{ url('laporan/perubahan-modal') }}">
      <div class="col-lg-3 col-sm-offset-1">
        <!-- small box -->
        <div class="small-box bg-yellow">
          <div class="inner">
            ...
            <p align="center">Laporan Perubahan Modal</p>
          </div>
          {{-- <div class="icon">
            <i class="ion ion-bag"></i>
          </div> --}}
      ...
      <div class="col-lg-3 col-sm-offset-1">
        ...
        <div class="small-box bg-yellow">
          <div class="inner">
            ...
            <p align="center">Laporan Neraca</p>
          </div>
          {{-- <div class="icon">
            <i class="ion ion-bag"></i>
          </div> --}}
